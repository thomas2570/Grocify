  ...
  return (
    <header className='bg-white fixed top-0 right-0 left-0'>
      <nav className=' max-w-[1400px] mx-auto px-10 md:h-[14vh] h-[12vh] flex justify-between items-center '>
        ...
        <ul className={`flex flex-col items-center gap-y-15 bg-orange-500/15 backdrop-blur-xl rounded-xl p-10 md:hidden absolute top-30 -left-full -translate-x-1/2 w-[calc(100%-5rem)] max-w-sm transition-all duration-500 ${showMenu ? 'left-1/2' : ""}`}>
          <li>
            <a href="#" className='font-semibold tracking-wider text-orange-500'>Home</a>
          </li>
          <li>
