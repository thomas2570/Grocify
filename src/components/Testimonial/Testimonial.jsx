    ...
    <section>
      <div className='max-w-[1400px] mx-auto px-10 py-20'>
        ...
        <div className='flex justify-end py-5 gap-x-3'>
          <button className='text-2xl text-zinc-800 rounded-lg w-11 flex justify-center items-center h-11 bg-zinc-100 hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer'>
            <IoIosArrowBack />
          </button>
          <button className='text-2xl text-zinc-800 rounded-lg w-11 flex justify-center items-center h-11 bg-zinc-100 hover:bg-gradient-to-b hover:from-orange-400 hover:to-orange-500 hover:text-white cursor-pointer'>
            <IoIosArrowForward />
            ...
            review.map(item => {
              return (
                <SwiperSlide className='bg-zinc-100 rounded-xl p-8'>
                  ...
                  <div className='mt-10'>
                    <p className='text-zinc-600'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odit veniam est atque dignissimos voluptatibus? Dicta unde, quae voluptates quos id nihil et similique. Esse debitis, modi fugit ullam in voluptates.</p>
                  </div>
                </SwiperSlide>
              )
            })
